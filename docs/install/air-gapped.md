...
![air-gapped install diagram](/img/Air-Gapped-Solution-Diagram.png)
...
The prepare script will use quite a bit of space. As it will be downloading many required packages and images. 
When you create your air-gapped machine ensure the root path has at least 50GB in order to create and store the files that get zipped into the tar.gz.
...
Your air-gapped LME instance must be on a network where your air-gapped endpoints can reach it. 
