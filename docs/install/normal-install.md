...
7. [Developer Notes](#7-developer-notes)
     ...
     7.1 [Git Clone and Git Checkout Notes](#71-git-clone-and-git-checkout)

     7.2 [Installation Details](#72-non-default-installation)

     7.3 [Notes on Folders, Permissions, and Service](#73-installation-details)
...
For a more detailed understanding of LME's architecture, reference the [LME Architecture Documentation](/docs/reference/architecture).
...
**Note: Reference the [Supported Linux Distribution documentation](/docs/reference/change-me/) for more information on recommended Linux distributions for installing LME.**
...
Please reference our documentation around Cloud and firewall setup for more information on how you can [expose these ports](/docs/logging-guidance/cloud).
...
If you're unsure whether your system meets the prerequisites for installing LME, reference our [Prerequisites Documentation](/docs/prerequisites).
...
- Reference our [Troubleshooting Guide](/docs/reference/troubleshooting#memory-in-containers-need-more-ramless-ram-usage) to configure Podman quadlets for reduced memory usage
...
If your server will support hundreds of clients, you'll need more resources and possibly a dedicated machine for Elasticsearch. Reference our [documentation for an expanded discussion around scaling LME](/docs/prerequisites#scaling-the-solution) or more information.
...
If you are upgrading from an older version of LME to LME 2.0, reference our [Upgrading documentation](/docs/maintenance/upgrading).
...
To populate the dashboards with data, you need to install agents. Detailed guides for deploying Wazuh and Elastic agents are available in the following documents:
 ...
 - [Deploy Wazuh Agent](/docs/agents/wazuh-agent-management)
   
 - [Deploying Elastic-Agent](/docs/agents/elastic-agent-management)
...
For more information on passwords, reference the [Password Encryption documentation](/docs/reference/passwords).
...
### 6.1 Logging Guidance
 ...
 - [LME in the Cloud](/docs/logging-guidance/cloud)
 - [Retention Settings](/docs/logging-guidance/retention)
 - [Filtering Logs in LME Cloud](/docs/logging-guidance/filtering)

### 6.2 Reference

 - [FAQ](/docs/reference/faq) 
 - [Dashboard Descriptions](/docs/reference/dashboard-descriptions)
 - [LME Security Model](/docs/reference/security-model)
 - [Architecture](/docs/reference/architecture)
 - [Configuring LME](/docs/reference/configuration)
 - [Password Encryption](/docs/reference/passwords)
 - [Troubleshooting LME Install](/docs/reference/troubleshooting)

### 6.3 Maintenance

 - [ElastAlert2 Rule Writing](/docs/maintenance/elastalert-rules)
 - [Backing Up LME Logs](/docs/maintenance/backups)  
 - [Certificates](/docs/maintenance/certificates) 
 - [Encryption at Rest](/docs/maintenance/encryption-at-rest)
 - Data management:
   - [Elasticsearch Index Lifecycle Management](/docs/maintenance/index-management)
   - [Podman Volume Management](/docs/maintenance/volume-management)
 - Upgrading:
   - [Upgrading 1x -> 2x](/docs/maintenance/upgrading) 
   - [Upgrading Future 2.x](/docs/maintenance/upgrading)

### 6.4 Agents

 - [Elastic Agent Management - Enrollment Guide](/docs/agents/elastic-agent-management)
 - Wazuh:
   - [Wazuh Configuration Management](/docs/maintenance/wazuh-configuration)
   - [Example Setup for Wazuh Active Response](/docs/agents/wazuh-active-response)
   - [LME Wazuh Agent Enrollment Guide](/docs/agents/wazuh-agent-management)
...
- **Windows**
  - [Installing Sysmon on Windows Machines (manual install)](/docs/endpoint-tools/install-sysmon)
    
- **Linux**
  - [Installing and Configuring Auditd on Linux Systems](/docs/endpoint-tools/install-auditd)
...
- Once you've gotten your changes/updates added, please submit a pull request following our [Guidelines](https://github.com/cisagov/lme/blob/main/CONTRIBUTING.md)
...
**Note: If you have issues accessing a file or directory, please note permissions and notes on folder structure [here](#73-folders-permissions-and-service)**.
...
- **Set service user passwords**: Sets the service user passwords that are encrypted according to the [LME Security Model](/docs/reference/security-model).
