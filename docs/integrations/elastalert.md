...
To understand how this works, reference the [ElastAlert Rules document](/docs/maintenance/elastalert-rules).
...
- Reference the [ElastAlert Rules documentation](/docs/maintenance/elastalert-rules) for more query possibilities.
...
Reference the [ElastAlert Rules documentation](/docs/maintenance/elastalert-rules) if you want even more advanced control.
