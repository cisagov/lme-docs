...
Please view the [install guide](/docs/install/normal-install).
...
If you're troubleshooting your installation, be sure to utilize our [troubleshooting documentation](/docs/reference/troubleshooting).
