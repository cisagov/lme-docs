...
![Snapshot and Restore](/img/backup_pics/snapshot_and_restore.png)

  - Click on the **Register a repository button**.

![Repository One](/img/backup_pics/repository_1.png)
...
![Repository Two](/img/backup_pics/repository_2.png)
...
![Policy One](/img/backup_pics/policy_1.png)
...
![Policy Six](/img/backup_pics/policy_6.png)
...
![NavBar](/img/nav-bar.png)  
![snaprestore](/img/snap-restore.png)  
...
![restore-details](/img/restore-details.png)
