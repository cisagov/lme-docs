...
- [Red Hat/CentOS/RHEL Systems](#for-red-hatcentosrhel-systems)
  - [Option 1: Using firewalld (Recommended)](#option-1-using-firewalld-recommended-for-most-users)
    - [Automated Configuration](#automated-nftables-configuration-recommended)
    - [Manual Configuration](#manual-nftables-configuration)
...
![cloud firewall](/img/lme-cloud.jpg)
